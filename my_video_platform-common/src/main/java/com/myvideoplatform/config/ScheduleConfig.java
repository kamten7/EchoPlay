package com.myvideoplatform.config;
...
public class ScheduleConfig {
    ...
    private com.myvideoplatform.config.Appconfig appconfig;

    @javax.annotation.Resource
    private com.myvideoplatform.mappers.UserWatchHistoryMapper userWatchHistoryMapper;

    @javax.annotation.Resource
    private com.myvideoplatform.service.UserWatchHistoryService userWatchHistoryService;
